...
var LightsT = function(I_pos, I_ambi, I_diff, I_spec) {
//===============================================================================
// Constructor function:
	var I_pos = I_pos;	// x,y,z,w:   w==1 for local 3D position,
															// w==0 for light at infinity in direction (x,y,z)
	var isLit = false;						// true/false for ON/OFF
	var I_ambi = I_ambi;		// ambient illumination: r,g,b
	var I_diff = I_diff;		// diffuse illumination: r,g,b.
	var I_spec = I_spec;		// specular illumination: r,g,b.
	//
