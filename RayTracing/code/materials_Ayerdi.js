...
var MATL_CHECKER_WHITE = 23;
var MATL_CHECKER_BLACK = 24;
var MATL_DEFAULT = 		   25;		// (used for unrecognized material names)
...
// This function DOES NOT CHANGE values of any of its uLoc_XX member variables.
    ...
    case MATL_CHECKER_WHITE: // 23
      ...
      this.K_mirr.push(0.3,     0.3,    0.3,    1.0);
      this.K_shiny = 89.6;
      this.K_name = "MATL_CHECKER_WHITE";
      break;
    case MATL_CHECKER_BLACK: // 24
      this.K_emit.push(0.0,      0.0,      0.0,      1.0);
      this.K_ambi.push(0.05375,  0.05,     0.06625,  0.82);
      this.K_diff.push(0.18275,  0.17,     0.22525,  0.82);
      this.K_spec.push(0.332741, 0.328634, 0.346435, 0.82);   
      this.K_mirr.push(0.3,     0.3,    0.3,    1.0);
      this.K_shiny = 89.6;
      this.K_name = "MATL_CHECKER_BLACK";
      break;
    default:
