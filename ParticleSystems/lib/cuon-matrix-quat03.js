 ...
 * Or, pass in a Float32ARray of length 16. AKA, another matrix's .elements
...
/** J. Tumblin 2018.02.01
 ...
 Vector3.prototype.sub = function (src) {
  ...
  Vector3.prototype.add = function (src) {
    var vA = this.elements;
    var ans = new Vector3([0.0, 0.0, 0.0]);
    var vC = ans.elements;
    if (!src || typeof src !== 'object' || !src.hasOwnProperty('elements')) {
  ...
  Vector3.prototype.scalarMult = function (scalar) {
    var ans = this;
    var vA = ans.elements;
    vA[0] *= scalar;
    vA[1] *= scalar;
